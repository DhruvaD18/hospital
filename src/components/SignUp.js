    ...
    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
      ...
      <form class="space-y-4 md:space-y-6" method="POST">
        ...
        <div>
          ...
          <input type="password" name="password" id="password" placeholder="Set password" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="" />
        </div>
        ...
        <div class="flex flex-col items-center">
            <button
                class="w-full max-w-xs font-bold shadow-md rounded-lg py-3 bg-blue-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
          ...
          <p class="text-sm font-light text-black text-center dark:text-gray-400">Already have an account? <Link
            class="font-medium text-blue-600 underline dark:text-blue-500" to={'/login'}>Sign in here</Link>
          </p>
      </form>
    </div>
  </div>
